...
%>
  ...
  <div class="con">
  <form action="Admission1" method="post"  enctype="multipart/form-data">
    ...
    Gender : <select name="gender">
      ...
      Select Files : <input type="file" name="tenth1" /><br><br>
      twelfth : <p>size should be less than 1024kb</p>
      Select Files : <input type="file" name="twelfth1" /><br><br>
